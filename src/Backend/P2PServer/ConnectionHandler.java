...
public class ConnectionHandler implements Runnable {
    ...
    ConnectionHandler(Socket socket, IMessageCallback callback) {
        this.socket = socket;
    ...
    public void run() {
        try {
            ...
            } else if (message.getMessage() instanceof CRDTController) {
                callback.onSnapshotReceived((CRDTController) message.getMessage());
